...
ι-congᵉ-2-0 : {T=S : T ≅ᵗʸ S} {S=T : S ≅ᵗʸ T} {t : Tm Γ T} →
              transᵗʸ T=S S=T ≅ᵉ reflᵗʸ →
              ι[ T=S ] (ι[ S=T ] t) ≅ᵗᵐ t
ι-congᵉ-2-0 𝑒 = transᵗᵐ (ι-congᵉ-2-1 𝑒) ι-refl

ι⁻¹-congᵉ-2-0 : {T=S : T ≅ᵗʸ S} {S=T : S ≅ᵗʸ T} {s : Tm Γ S} →
                transᵗʸ S=T T=S ≅ᵉ reflᵗʸ →
                ι⁻¹[ T=S ] (ι⁻¹[ S=T ] s) ≅ᵗᵐ s
ι⁻¹-congᵉ-2-0 𝑒 = transᵗᵐ (ι⁻¹-congᵉ-2-1 𝑒) ι⁻¹-refl
