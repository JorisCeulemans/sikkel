...
allnow-ty : Ty (timeless-ctx Γ) ℓ → Ty Γ ℓ
...
allnow-ty-cong : {T : Ty (timeless-ctx Γ) ℓ} {S : Ty (timeless-ctx Γ) ℓ'} →
...
allnow-ty-natural : (σ : Δ ⇒ Γ) {T : Ty (timeless-ctx Γ) ℓ} → (allnow-ty T) [ σ ] ≅ᵗʸ allnow-ty (T [ timeless-subst σ ])
