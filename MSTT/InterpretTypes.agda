...
open import Model.DRA as DRA hiding (𝟙; ⟨_∣_⟩; _,lock⟨_⟩)
...
⟦ ◇ ⟧ctx = M.◇
⟦ Γ , μ ∣ _ ∈ T ⟧ctx = ⟦ Γ ⟧ctx M.,, DRA.⟨ ⟦ μ ⟧modality ∣ ⟦ T ⟧ty ⟩
⟦ Γ ,lock⟨ μ ⟩ ⟧ctx = ⟦ Γ ⟧ctx DRA.,lock⟨ ⟦ μ ⟧modality ⟩
...
⟦⟧ty-natural ⟨ μ ∣ T ⟩ = DRA.dra-closed ⟦ μ ⟧modality (⟦⟧ty-natural T)
