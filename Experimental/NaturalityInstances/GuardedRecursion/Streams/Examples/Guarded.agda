...
module Experimental.NaturalityInstances.GuardedRecursion.Streams.Examples.Guarded where
...
open import Experimental.NaturalityInstances.GuardedRecursion.Streams.Guarded
