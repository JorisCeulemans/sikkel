...
SemPropConstructor []                   []                   Γ = SemTy ⟦ Γ ⟧ctx
SemPropConstructor []                   (bp-info ∷ bp-infos) Γ =
  SemTy ⟦ Γ ++tel arg-tel bp-info ⟧ctx → SemPropConstructor [] bp-infos Γ
SemPropConstructor (tm-info ∷ tm-infos) bp-infos             Γ =
  SemTm ⟦ Γ ++tel tmarg-tel tm-info ⟧ctx ⟦ tmarg-ty tm-info ⟧ty → SemPropConstructor tm-infos bp-infos Γ
