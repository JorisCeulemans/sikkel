...
⟦ⓜ⟧-sound (non-triv nt-forever) 𝟙 = M.symᵐ (M.𝟙-identityʳ _)
...
⟦ⓜ⟧-sound (non-triv nt-forever) (non-triv later^[ suc n ]ⓜconstantlyⓜforever) =
  M.transᵐ (M.transᵐ (⟦ⓜ⟧-sound (non-triv nt-forever) (non-triv later^[ n ]ⓜconstantlyⓜforever))
                     (M.ⓜ-congʳ _ (M.symᵐ M.forever-later)))
           (M.ⓜ-assoc _ _ _)
⟦ⓜ⟧-sound (non-triv later^[ n ]ⓜconstantly) 𝟙 = M.symᵐ (M.𝟙-identityʳ _)
...
⟦ⓜ⟧-sound (non-triv later^[ suc n ]ⓜconstantly) (non-triv nt-forever) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[ n ]ⓜconstantly) forever)) (M.symᵐ (M.ⓜ-assoc _ _ _))
⟦ⓜ⟧-sound (non-triv later^[1+ n ]) 𝟙 = M.symᵐ (M.𝟙-identityʳ _)
⟦ⓜ⟧-sound (non-triv later^[1+ zero  ]) (non-triv later^[ m ]ⓜconstantly) = M.reflᵐ
⟦ⓜ⟧-sound (non-triv later^[1+ suc n ]) (non-triv later^[ m ]ⓜconstantly) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[1+ n ]) (non-triv later^[ m ]ⓜconstantly))) (M.symᵐ (M.ⓜ-assoc _ _ _))
⟦ⓜ⟧-sound (non-triv later^[1+ zero  ]) (non-triv later^[1+ m ]) = M.reflᵐ
⟦ⓜ⟧-sound (non-triv later^[1+ suc n ]) (non-triv later^[1+ m ]) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[1+ n ]) (non-triv later^[1+ m ]))) (M.symᵐ (M.ⓜ-assoc _ _ _))
...
⟦ⓜ⟧-sound (non-triv later^[1+ suc n ]) (non-triv later^[ m ]ⓜconstantlyⓜforever) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[1+ n ]) (non-triv later^[ m ]ⓜconstantlyⓜforever))) (M.symᵐ (M.ⓜ-assoc _ _ _))
⟦ⓜ⟧-sound (non-triv later^[ n ]ⓜconstantlyⓜforever) 𝟙 = M.symᵐ (M.𝟙-identityʳ _)
...
⟦ⓜ⟧-sound (non-triv later^[ suc n ]ⓜconstantlyⓜforever) (non-triv later^[ m ]ⓜconstantly) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[ n ]ⓜconstantlyⓜforever) (non-triv later^[ m ]ⓜconstantly))) (M.symᵐ (M.ⓜ-assoc _ _ _))
⟦ⓜ⟧-sound (non-triv later^[ zero ]ⓜconstantlyⓜforever) (non-triv later^[1+ zero  ]) =
  M.symᵐ (M.transᵐ (M.ⓜ-assoc _ _ _) (M.ⓜ-congˡ _ M.forever-later))
...
⟦ⓜ⟧-sound (non-triv later^[ suc n ]ⓜconstantlyⓜforever) (non-triv later^[1+ m ]) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[ n ]ⓜconstantlyⓜforever) (non-triv later^[1+ m ]))) (M.symᵐ (M.ⓜ-assoc _ _ _))
...
⟦ⓜ⟧-sound (non-triv later^[ suc n ]ⓜconstantlyⓜforever) (non-triv later^[ m ]ⓜconstantlyⓜforever) =
  M.transᵐ (M.ⓜ-congˡ _ (⟦ⓜ⟧-sound (non-triv later^[ n ]ⓜconstantlyⓜforever) (non-triv later^[ m ]ⓜconstantlyⓜforever))) (M.symᵐ (M.ⓜ-assoc _ _ _))
...
⟦ 𝟙≤ltr {k = suc k} ⟧two-cell = (M.𝟙≤later M.ⓣ-hor ⟦ 𝟙≤ltr {k = k} ⟧two-cell) M.ⓣ-vert M.≅ᵐ-to-2-cell (M.symᵐ (M.𝟙-identityˡ _))
...
⟦ cstⓜfrv≤ltr {l = suc l} z≤n ⟧two-cell = (M.𝟙≤later M.ⓣ-hor ⟦ cstⓜfrv≤ltr {l = l} z≤n ⟧two-cell) M.ⓣ-vert M.≅ᵐ-to-2-cell (M.symᵐ (M.𝟙-identityˡ _))
⟦ cstⓜfrv≤ltr {l = zero } (s≤s z≤n)   ⟧two-cell = M.≅ᵐ-to-2-cell (M.𝟙-identityʳ _) M.ⓣ-vert (M.id-cell M.ⓣ-hor M.constantly∘forever≤𝟙)
