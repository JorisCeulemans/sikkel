...
module Experimental.DependentTypes.DeepEmbedding.Syntax (mt : ModeTheory) where
...
data TmExpr where
  ...
  refl : TmExpr m → TmExpr m → TmExpr m
...
show-type (Id t s) = "Identity type" -- TODO: show-term + better representation for this case
